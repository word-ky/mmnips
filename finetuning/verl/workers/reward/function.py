    ...
    def compute_reward(
        ...
        for i in range(len(data)):
            ...
            try:
                ...
                print(f"Response: {response_ids[i]}")
                print(f"Response length: {response_length[i]}")
                raise ValueError(
                    f">>>>>>> {e} valid_response_ids {valid_response_ids} ground_truth {data.non_tensor_batch['ground_truth'][i]}"
                )
